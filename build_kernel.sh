...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"6.1.6"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"060106"}
...
# Examples:
# 6.1.6-060106+customidle-generic
# 6.1.6-060106+customfull-generic
# 6.1.6-060106+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 6.1.6-060106+custom-idle-generic, so just keep it combined
...
# To uninstall a kernel: sudo apt purge *6.1.6-060106+customidle-generic*
