...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.4.154"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"0504154"}
...
# Examples:
# 5.4.154-0504154+customidle-generic
# 5.4.154-0504154+customfull-generic
# 5.4.154-0504154+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.4.154-0504154+custom-idle-generic, so just keep it combined
...
#
# To uninstall a kernel: $ sudo apt purge *5.4.154-0504154+customidle-generic*
