...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.4.140"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"0504140"}
...
if [ ${KERNEL_BASE_VER} = "5.13" ]; then
    ...
    patch -p1 < ./0003-drm-amdgpu-handle-VCN-instances-when-harvesting.patch;
...
# Examples:
# 5.4.140-0504140+customidle-generic
# 5.4.140-0504140+customfull-generic
# 5.4.140-0504140+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.4.140-0504140+custom-idle-generic, so just keep it combined
