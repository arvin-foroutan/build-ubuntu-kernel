...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.15.10"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"051510"}
...
if [ ${KERNEL_BASE_VER} == "5.16" ]; then   # Latest -rc, currently in development
    ...
    cp -v ${LUCJAN_PATCH_PATH}/5.15/cpufreq-patches-v5/*.patch .;
...
# Examples:
# 5.15.10-051510+customidle-generic
# 5.15.10-051510+customfull-generic
# 5.15.10-051510+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.15.10-051510+custom-idle-generic, so just keep it combined
...
#
# To uninstall a kernel: $ sudo apt purge *5.15.10-051510+customidle-generic*
