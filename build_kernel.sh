...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.15.11"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"051511"}
...
# Examples:
# 5.15.11-051511+customidle-generic
# 5.15.11-051511+customfull-generic
# 5.15.11-051511+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.15.11-051511+custom-idle-generic, so just keep it combined
...
#
# To uninstall a kernel: $ sudo apt purge *5.15.11-051511+customidle-generic*
