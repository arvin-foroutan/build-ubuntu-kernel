...
if [ ${KERNEL_TYPE} == "rt" ]; then
    ...
    if [ ${KERNEL_BASE_VER} == "5.15" ]; then
        cp -v ${CUSTOM_PATCH_PATH}/rt/${KERNEL_BASE_VER}/patch-5.15-rc2-rt3.patch .;
        patch -p1 < ./patch-5.15-rc2-rt3.patch;
...
if [ ${KERNEL_BASE_VER} == "5.15" ]; then   # Latest mainline, in -rc right now
    ...
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}/ntfs3-patches-v10/*.patch .;
