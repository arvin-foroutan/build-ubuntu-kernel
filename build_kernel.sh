...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.19.3"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"051903"}
...
# Examples:
# 5.19.3-051903+customidle-generic
# 5.19.3-051903+customfull-generic
# 5.19.3-051903+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.19.3-051903+custom-idle-generic, so just keep it combined
...
# To uninstall a kernel: sudo apt purge *5.19.3-051903+customidle-generic*
