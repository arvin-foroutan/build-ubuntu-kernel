...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"6.9.6"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"060906"}
...
# Examples:
# 6.9.6-060906+customidle-generic
# 6.9.6-060906+customfull-generic
# 6.9.6-060906+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 6.9.6-060906+custom-idle-generic, so just keep it combined
...
# To uninstall a kernel: sudo apt purge *6.9.6-060906+customidle-generic*
