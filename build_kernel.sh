...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"6.9.7"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"060907"}
...
# Examples:
# 6.9.7-060907+customidle-generic
# 6.9.7-060907+customfull-generic
# 6.9.7-060907+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 6.9.7-060907+custom-idle-generic, so just keep it combined
...
# To uninstall a kernel: sudo apt purge *6.9.7-060907+customidle-generic*
