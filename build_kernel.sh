...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.4.153"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"0504153"}
...
# Examples:
# 5.4.153-0504153+customidle-generic
# 5.4.153-0504153+customfull-generic
# 5.4.153-0504153+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.4.153-0504153+custom-idle-generic, so just keep it combined
...
#
# To uninstall a kernel: $ sudo apt purge *5.4.153-0504153+customidle-generic*
