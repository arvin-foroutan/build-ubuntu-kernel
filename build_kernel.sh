...
if [ ${AMDGPU_BUILTIN} = "yes" ]; then
    ...
    # For example, for Navi: ls amdgpu/navi* and popular EXTRA_FIRMWARE with Vega blobs. This will be done
    # automatically in a future verison. For now, just do Polaris.
    echo "Updating config to build-in amdgpu... ✓";
