...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"6.6.4"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"060604"}
...
# Examples:
# 6.6.4-060604+customidle-generic
# 6.6.4-060604+customfull-generic
# 6.6.4-060604+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 6.6.4-060604+custom-idle-generic, so just keep it combined
...
# To uninstall a kernel: sudo apt purge *6.6.4-060604+customidle-generic*
