...
if [ ${KERNEL_BASE_VER} == "6.15" ]; then   # Latest rc
    ...
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}-rc/asus-patches/*.patch .;
    ...
    patch -p1 < ./0001-amd-pstate-patches.patch;
    echo "*** Copying and applying amd tlb patches.. ✓";
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}/amd-tlb-broadcast-patches-v10-all/*.patch .;
    patch -p1 < ./0001-amd-tlb-broadcast-patches.patch;
    echo "*** Copying and applying arch patches.. ✓";
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}/arch-patches-v2/*.patch .;
    patch -p1 < ./0001-arch-patches.patch;
    ...
    patch -p1 < ./0011-EDAC-igen6-Fix-the-flood-of-invalid-error-reports.patch;
    echo "*** Copying and applying clearlinux patches.. ✓";
    ...
    patch -p1 < ./0001-pid-patches.patch;
    echo "*** Copying and applying t2 patches.. ✓";
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}/t2-patches-v3/*.patch .;
    patch -p1 < ./0001-t2-patches.patch;
    ...
    echo "*** Copying and applying v4l2loopback patches.. ✓";
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}/v4l2loopback-patches-v3/*.patch .;
    patch -p1 < ./0001-v4l2loopback-patches.patch;
    echo "*** Copying and applying zstd cachyos patches.. ✓";
    cp -v ${LUCJAN_PATCH_PATH}/${KERNEL_BASE_VER}/zstd-cachyos-patches-v4/*.patch .;
