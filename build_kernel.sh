...
KERNEL_PATCH_VER=${KERNEL_PATCH_VER:-"5.16.8"}
KERNEL_SUB_VER=${KERNEL_SUB_VER:-"051608"}
...
# Examples:
# 5.16.8-051608+customidle-generic
# 5.16.8-051608+customfull-generic
# 5.16.8-051608+customrt-generic
# Note: A hyphen between label and type (e.g. customidle -> custom-idle) causes problems with some parsers
# Because the final version name becomes: 5.16.8-051608+custom-idle-generic, so just keep it combined
...
#
# To uninstall a kernel: $ sudo apt purge *5.16.8-051608+customidle-generic*
